...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="index.html"><img src="images/logo-001.svg" alt="alternative"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#">소개</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#">스터디</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="article-details.html"><span class="item-text">원티드</span></a>
                            <div class="dropdown-items-divide-hr"></div>
                            <a class="dropdown-item" href="terms-conditions.html"><span
                                    class="item-text">잡코리아</span></a>
                            <div class="dropdown-items-divide-hr"></div>
                            <a class="dropdown-item" href="privacy-policy.html"><span class="item-text">사람인</span></a>
                        </div>
                    </li>
                    <!-- end of dropdown menu -->

                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#">지도</a>
                    </li>
                ...
                <span class="nav-item">
                    <a class="btn-outline-sm" href="log-in.html">로그인</a>
                </span>
                <span class="nav-item">
                    <a class="btn-outline-sm" href="sign-up.html">회원가입</a>
                </span>
            </div>
        ...
        <div class="container">
            <div class="row" style="text-align: center;">
                <div style="text-align:center">
                    ...
                    <br><br><br><br>
                <img src="images/java01.png" class="rounded float-start" alt="...">
                <img src="images/node.js04.png" class="rounded float-end" alt="...">
                <img src="images/spring06.png" class="rounded float-start" alt="...">
                <img src="images/python05.png" class="rounded float-end" alt="...">
                <img src="images/kotlin03.png" class="rounded float-end" alt="...">
                <img src="images/javascript02.png" class="rounded float-end" alt="...">              
                </div><!-- 검색-->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
