			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="slider-container">
						<div
							class="swiper-container image-slider swiper-container-horizontal">
							<div class="swiper-wrapper"
								...
								<div class="swiper-slide swiper-slide-duplicate"
									...
									<img class="img-fluid" src="resources/images/javascript02.png"
										alt="alternative">
								</div>
								<div
									...
									style="width: 178.8px; margin-right: 30px;">
									<img class="img-fluid" src="resources/images/kotlin03.png"
										alt="alternative">
								</div>
								<div
									...
									style="width: 178.8px; margin-right: 30px;">
									<img class="img-fluid" src="resources/images/node.js04.png"
										alt="alternative">
								</div>
								<div
									...
									<img class="img-fluid" src="resources/images/python05.png"
										alt="alternative">
								</div>
								<div class="swiper-slide swiper-slide-duplicate"
									style="width: 178.8px; margin-right: 30px;"
									data-swiper-slide-index="5">
									<img class="img-fluid" src="resources/images/spring06.png"
										alt="alternative">
								</div>
								<div class="swiper-slide"
									style="width: 178.8px; margin-right: 30px;"
									data-swiper-slide-index="0">
									<img class="img-fluid" src="resources/images/java01.png"
										alt="alternative">
								</div>
								<div class="swiper-slide"
									style="width: 178.8px; margin-right: 30px;"
				...
				<div class="col-lg-12">
					...
					<div class="card">
						<div class="card-image">
							<img class="img-fluid" src="resources/images/description-1.png"
								alt="alternative">
						</div>
						<div class="card-body">
					...
					<div class="card">
						<div class="card-image">
							<img class="img-fluid" src="resources/images/description-2.png"
								alt="alternative">
						</div>
						<div class="card-body">
					...
					<div class="card">
						<div class="card-image">
							<img class="img-fluid" src="resources/images/description-3.png"
								alt="alternative">
						</div>
						<div class="card-body">
							<h4 class="card-title">커리어</h4>
							<p>포트폴리오에 추가할 미니 프로젝트를 하고 싶은데 나혼자 하는 것 보다 다른 사람들과 함께 해보고
								싶은데...</p>
						</div>
					</div>
					<!-- end of card -->
						...
						<div class="tab-pane fade show active" id="tab-1" role="tabpanel"
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="image-container">
										<img class="img-fluid"
											src="resources/images/Hello World-001.png" alt="alternative">
									</div>
									<!-- end of image-container -->
								</div>
								<!-- end of col -->
								<div class="col-lg-6">
									<div class="text-container">
										<h2>Hello Word!</h2>
										<p>
											코딩을 처음 하시는 분들이 처음으로 발자국을 찍게 되는 Hello World! 코끼리 홈페이지에 접속하시고
											홈페이지에서 가이드를 읽으신 후<br> 코끼리 이용을 위한 로그인/회원가입을 해주세요.<br>
											<a class="blue page-scroll" href="signup">Sign Up Form</a>
										</p>
										<ul class="list-unstyled li-space-lg">
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">홈페이지의 가이드 읽기</div></li>
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">로그인/회원가입</div></li>
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">스터디 이용</div></li>
										</ul>
						...
						<div class="tab-pane fade" id="tab-2" role="tabpanel"
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="image-container">
										<img class="img-fluid"
											src="resources/images/Hello World-002.png" alt="alternative">
									</div>
									<!-- end of image-container -->
								</div>
								<!-- end of col -->
								<div class="col-lg-6">
									<div class="text-container">
										<h2>FINDING STUDY</h2>
										<p>
											로그인을 해주신 여러분 축하드립니다!<i class="fa-solid fa-hands-clapping"></i><br>
											공부를 위한 멋진 한 걸음을 내딛은 여러분은 이제 다른 분들과 함께 <br>스터디를 진행하게 될
											거예요!
										</p>
										<ul class="list-unstyled li-space-lg">
											<li class="media"><i class="fas fa-square"></i>
											...
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">원하시는 언어를 골라주세요! 직접 스터디를 만들 수도
													있어요!</div></li>
											<li class="media"><i class="fas fa-square"></i>
						...
						<div class="tab-pane fade" id="tab-3" role="tabpanel"
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="image-container">
										<img class="img-fluid"
											src="resources/images/Hello-World-003.png" alt="alternative">
									</div>
									<!-- end of image-container -->
								</div>
								<!-- end of col -->
								<div class="col-lg-6">
									<div class="text-container">
										<h3>ENJOY KOGGIRI</h3>
										<p>
											스터디를 직접 만들어 보거나 가입 하셨나요? 훌륭합니다! <br> 코끼리에서는 스터디 활동뿐만 아니라
											취업을 위한 취업사이트를<br> 살펴보거나, 스터디를 위해 주변의 스터디룸을 찾아볼 수 있습니다. <br>
											코끼리를 통하여 원하시는 목적 달성을 응원합니다!
										</p>
										<ul class="list-unstyled li-space-lg">
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">각종 취업사이트를 한 곳에서 바로 이동해보세요!</div></li>
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">스터디원들과 만나기위한 스터디룸을 지도에서 찾아보세요!</div>
											</li>
											<li class="media"><i class="fas fa-square"></i>
												<div class="media-body">코끼리를 통하여 편리하고 즐거운 스터디를 해보세요!</div></li>
										</ul>
										<a class="btn-solid-reg popup-with-move-anim"
	...
	<div id="details-lightbox-1"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="image-container">
						<img class="img-fluid" src="resources/images/detail-001.png"
							alt="alternative">
					</div>
					<!-- end of image-container -->
				</div>
				...
				<div class="col-lg-4">
					...
					<h5>Core service</h5>
					<p>
						코끼리에서는 간편한 회원가입을 통하여 스터디를 할 수 있습니다.<br> 회원가입시에는 개인정보를 요구하지
						않으니 걱정말고 가입하세요! :)
					</p>
					<ul class="list-unstyled li-space-lg">
						<li class="media"><i class="fas fa-square"></i>
	...
	<div id="details-lightbox-2"
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="image-container">
						<img class="img-fluid" src="resources/images/details-lightbox.png"
							alt="alternative">
					</div>
					<!-- end of image-container -->
				</div>
				...
				<div class="col-lg-4">
					...
					<h5>Core service</h5>
					<p>
						마음에 드는 스터디도 많지만 직접 원하는 스터디를 만들어서<br> 운영해보는 것도 또다른 성취일거예요!
					</p>
					<ul class="list-unstyled li-space-lg">
						<li class="media"><i class="fas fa-square"></i>
							<div class="media-body">Automate user signup</div></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4">
					...
					<hr>
					<h5>Core service</h5>
					<p>다들 공부를 위하여 스터디에 가입하지만 개인마다 구체적인 목적이나 이유는 다를거예요. 모든이의 맘에 들기를
						바라면서 채용이 목적이라면 채용사이트를, 소통을 원하면 스터디룸 찾기를 이용하면서 항상 즐거운 코딩을 하기를 바랍니다!
					</p>
					<ul class="list-unstyled li-space-lg">
						<li class="media"><i class="fas fa-square"></i>
							<div class="media-body">Automate user signup</div></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					<div class="text-container">
						<h1>
							자, 시간이 되었습니다. <br>코끼리를 시작해봅시다!
						</h1>
						<br>
						<br> <a class="btn-solid-reg page-scroll" href="signup">SIGN
							UP</a>
					</div>
					<!-- end of text-container -->
				</div>
				...
				<div class="col-lg-6">
					<div class="image-container">
						<img class="img-fluid" src="resources/images/start.png"
							alt="alternative">
					</div>
					<!-- end of image-container -->
				</div>
					...
					<div class="image-container">
						<div class="video-wrapper">
							<a class="popup-youtube"
								...
								src="resources/images/video.png" alt="alternative"> <span
					...
					<div class="slider-container">
						<div
							...
							<div class="swiper-wrapper"
								...
								<div class="swiper-slide swiper-slide-duplicate"
									data-swiper-slide-index="3" style="width: 943px;">
									<div class="image-wrapper">
										<img class="img-fluid" src="resources/images/kakao.png"
											alt="alternative">
									</div>
								...
								<div class="swiper-slide swiper-slide-prev"
									...
									<div class="image-wrapper">
										<img class="img-fluid" src="resources/images/naver.png"
											alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
										<div class="testimonial-text">BackEnd Developer/Team
											Leader</div>
								...
								<!-- Slide -->
								<div class="swiper-slide swiper-slide-active"
									data-swiper-slide-index="1" style="width: 943px;">
									<div class="image-wrapper">
										<img class="img-fluid" src="resources/images/carrot.png"
											alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
								...
								<!-- Slide -->
								<div class="swiper-slide swiper-slide-next"
									data-swiper-slide-index="2" style="width: 943px;">
									<div class="image-wrapper">
										<img class="img-fluid" src="resources/images/kakao.png"
											alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
										<div class="testimonial-text">FrontEnd Developer</div>
								...
								<div class="swiper-slide" data-swiper-slide-index="3"
									style="width: 943px;">
									<div class="image-wrapper">
										<img class="img-fluid" src="resources/images/woo-ah.png"
											alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
						...
						<ul class="list-unstyled li-space-lg p-small">
							<li class="media"><i class="fas fa-square"></i>
								<div class="media-body">
									Our business partners <a class="white" href="#your-link">띠용</a>
								</div></li>
							<li class="media"><i class="fas fa-square"></i>
								<div class="media-body">
									Read our <a class="white" href="terms-conditions.html">Terms
					...
					<div class="footer-col last">
						...
						<ul class="list-unstyled li-space-lg p-small">
							<li class="media"><i class="fas fa-map-marker-alt"></i>
								<div class="media-body">South Korea, Home Ann Bang</div></li>
